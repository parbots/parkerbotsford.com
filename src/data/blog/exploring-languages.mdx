...
for i in range(1, 101):
    if i % 15 == 0: # [!code highlight]
        print("FizzBuzz") # [!code highlight]
    elif i % 3 == 0:
        print("Fizz")
    elif i % 5 == 0:
        print("Buzz")
...
function fizzBuzz(n: number): string {
  // [!code focus]
  if (n % 15 === 0) return "FizzBuzz"; // [!code focus]
  if (n % 3 === 0) return "Fizz"; // [!code focus]
  if (n % 5 === 0) return "Buzz"; // [!code focus]
  return String(n); // [!code focus]
} // [!code focus]
...
fn main() {
    for i in 1..=100 {
        let result = match (i % 3, i % 5) {
            (0, 0) => String::from("FizzBuzz"), // [!code highlight]
